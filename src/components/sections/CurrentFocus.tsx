...
export function CurrentFocus() {
  return (
    <Reveal>
      <section className="rounded-2xl border border-line/70 bg-gradient-to-r from-paper to-accentSoft/30 p-6 md:p-8">
        <p className="text-xs font-semibold uppercase tracking-[0.24em] text-muted">Current Focus</p>
        <h2 className="mt-3 font-display text-2xl text-accent md:text-3xl">
