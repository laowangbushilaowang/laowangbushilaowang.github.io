...
export function HomeHero() {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-line/70 bg-paper/90 p-8 shadow-card md:p-12">
      ...
      <div className="absolute -bottom-24 -left-16 h-52 w-52 rounded-full bg-highlight/25 blur-3xl" aria-hidden />

      <Reveal>
        <p className="text-sm font-semibold uppercase tracking-[0.22em] text-muted">Academic Homepage</p>
      </Reveal>
      <Reveal delay={0.06}>
        <h1 className="mt-4 font-display text-4xl leading-tight text-accent md:text-6xl">
